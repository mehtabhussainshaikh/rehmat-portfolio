...
export function CaseStudyCard({
  ...
  return (
    <div className="group relative aspect-video overflow-hidden rounded-xl bg-primary-bg-2 transition-premium hover:shadow-[0_20px_40px_rgba(232,180,79,0.15)]">
      <Image
        src={image}
        alt={title}
        fill
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[rgba(15,23,42,0.95)] via-[rgba(15,23,42,0.5)] to-transparent" />
      ...
      <div className="absolute inset-x-0 bottom-0 flex flex-col gap-3 p-6 opacity-100 transition-premium sm:translate-y-4 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100">
        ...
        <span className="mt-1 flex items-center gap-2 text-sm font-semibold text-primary-accent">
          View Case Study
          <ArrowRight size={16} />
        </span>
      </div>
