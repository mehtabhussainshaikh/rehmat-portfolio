...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-[900px] px-5 py-16 md:px-8 lg:px-10 lg:py-[120px]">
      <h1 className="heading-1 text-navy">Terms of Service</h1>
      <p className="mt-4 text-sm text-text-navy-secondary">Last updated: January 2024</p>

      <div className="mt-10 flex flex-col gap-8">
        <section>
          <h2 className="heading-3 text-navy">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="heading-3 text-navy">2. Use of Content</h2>
          <p className="mt-4 text-base leading-relaxed text-text-navy-secondary">
        ...
        <section>
          <h2 className="heading-3 text-navy">3. Services</h2>
          <p className="mt-4 text-base leading-relaxed text-text-navy-secondary">
        ...
        <section>
          <h2 className="heading-3 text-navy">4. Limitation of Liability</h2>
          <p className="mt-4 text-base leading-relaxed text-text-navy-secondary">
        ...
        <section>
          <h2 className="heading-3 text-navy">5. Changes to Terms</h2>
          <p className="mt-4 text-base leading-relaxed text-text-navy-secondary">
        ...
        <section>
          <h2 className="heading-3 text-navy">6. Contact Us</h2>
          <p className="mt-4 text-base leading-relaxed text-text-navy-secondary">
