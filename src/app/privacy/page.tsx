...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-[900px] px-5 py-16 md:px-8 lg:px-10 lg:py-[120px]">
      <h1 className="heading-1 text-ink">Privacy Policy</h1>
      <p className="mt-4 text-sm text-text-ink-secondary">Last updated: January 2024</p>

      <div className="mt-10 flex flex-col gap-8">
        <section>
          <h2 className="heading-3 text-ink">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="heading-3 text-ink">2. How We Use Information</h2>
          <p className="mt-4 text-base leading-relaxed text-text-ink-secondary">
        ...
        <section>
          <h2 className="heading-3 text-ink">3. Data Retention</h2>
          <p className="mt-4 text-base leading-relaxed text-text-ink-secondary">
        ...
        <section>
          <h2 className="heading-3 text-ink">4. Your Rights</h2>
          <p className="mt-4 text-base leading-relaxed text-text-ink-secondary">
        ...
        <section>
          <h2 className="heading-3 text-ink">5. Contact Us</h2>
          <p className="mt-4 text-base leading-relaxed text-text-ink-secondary">
